...
export type MatchParticipantWithChild = z.infer<
  typeof MatchParticipantWithChildSchema
>;
...
export const CreateMatchRequestSchema = z.object({
  childIds: z
    .array(z.string().uuid())
    .min(2, 'At least 2 children required for a match'),
});
...
export type GetPotentialMatchesQuery = z.infer<
  typeof GetPotentialMatchesQuerySchema
>;
