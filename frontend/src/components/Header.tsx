                ...
                {mobileMenuOpen && (
                    <div className="md:hidden mt-4 pb-4 space-y-4 border-t border-white/20 pt-4 mobile-menu-enter">
                        ...
                        {isDashboard ? (
                            ...
                            <Link href="/dashboard" className="block w-full py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-700 font-medium text-center transition-all" onClick={() => setMobileMenuOpen(false)}>
                                Dashboard
                            </Link>
                        ) : (
                            <Link href="/login" className="block w-full py-3 bg-gradient-primary text-white rounded-xl font-bold text-center transition-all" onClick={() => setMobileMenuOpen(false)}>
                                Prijavi se
                            </Link>
                        )}
                    </div>
