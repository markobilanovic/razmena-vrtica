    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-4 pt-24">
      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl p-8 relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2 tracking-tight font-outfit">
            Dobrodošli
          </h1>
        ...
        <form className="space-y-6" onSubmit={handleRegister}>
          ...
          >
            {registerMutation.isPending ? "Kreiram nalog..." : "Registruj se"}
          </button>
        </form>
        ...
        <button
          ...
          className="w-full py-3.5 px-6 bg-white/5 hover:bg-white/10 border border-white/10 active:scale-[0.98] rounded-xl font-medium text-white transition-all duration-200 flex items-center justify-center gap-3 group mb-8"
        >
          <svg
