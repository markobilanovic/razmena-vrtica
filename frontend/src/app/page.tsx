...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              <div className="inline-block mb-4 px-4 py-2 bg-blue-100 rounded-full">
                <span className="text-sm font-semibold text-blue-600">🎉 Nova platforma za roditelje</span>
              </div>
              <h1 className="mb-6">
                Pronađite idealnu <span className="gradient-text">razmenu vrtića</span> za vaše dete
              </h1>
              ...
              <div className="relative">
                ...
                <div className="glass-card rounded-3xl p-8 aspect-square flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-semibold text-color-text-muted">Vaš novi vrtić čeka</p>
                  </div>
                </div>
                ...
                <div className="absolute -top-6 -left-6 glass-card rounded-2xl p-4 animate-pulse-glow">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-color-text-muted">Aktivnih roditelja</p>
                      <p className="text-2xl font-bold">500+</p>
                    </div>
                  </div>
                </div>

                <div className="absolute -bottom-6 -right-6 glass-card rounded-2xl p-4 animate-pulse-glow" style={{ animationDelay: '1s' }}>
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-success rounded-xl flex items-center justify-center">
                      <span className="text-2xl">✅</span>
                    </div>
                    <div>
                      <p className="text-sm text-color-text-muted">Uspešnih razmena</p>
      ...
      <section id="features" className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="mb-6">Zašto koristiti <span className="gradient-text">Razmenu Vrtića</span>?</h2>
            ...
            {[
              {
                ...
                description: 'Pretražite dostupne razmene po gradu, opštini i vrtiću koji vam odgovara.'
              },
              {
                icon: '🔔',
                title: 'Notifikacije u realnom vremenu',
                description: 'Dobijte obaveštenje čim se pojavi razmena koja odgovara vašim potrebama.'
              },
              {
                icon: '💬',
                title: 'Direktna komunikacija',
                description: 'Stupite u kontakt sa drugim roditeljima i dogovorite detalje razmene.'
              },
              {
                icon: '🔒',
                title: 'Sigurno i pouzdano',
                description: 'Vaši podaci su zaštićeni, a svi korisnici su verifikovani.'
              },
              {
                icon: '📱',
                title: 'Mobilna aplikacija',
                description: 'Pristupite platformi sa bilo kog uređaja, u bilo koje vreme.'
              },
              {
                icon: '⚡',
      ...
      <section id="how-it-works" className="py-32 px-6 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="mb-6">Kako to <span className="gradient-text">funkcioniše</span>?</h2>
            <p className="text-xl text-color-text-muted max-w-2xl mx-auto">
            ...
            {[
              {
                ...
                description: 'Napravite nalog i popunite informacije o vrtiću koji trenutno imate i onom koji želite.'
              },
              {
                step: '02',
                title: 'Pronađite podudaranje',
                description: 'Naš algoritam automatski pronalazi roditelje koji traže ono što vi nudite.'
              },
              {
                step: '03',
                title: 'Dogovorite razmenu',
                description: 'Stupite u kontakt, dogovorite se i finalizujte razmenu sa drugim roditeljem.'
              }
            ].map((item, index) => (
      ...
      <section id="testimonials" className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="mb-6">Šta kažu <span className="gradient-text">roditelji</span>?</h2>
            <p className="text-xl text-color-text-muted max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={index} className="feature-card">
                ...
                <p className="text-color-text-muted mb-6 italic">&quot;{testimonial.text}&quot;</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-color-text-muted">{testimonial.location}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-32 px-6 bg-gradient-to-br from-blue-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-white mb-8">Spremni da pronađete savršenu razmenu?</h2>
          <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
            Pridružite se stotinama zadovoljnih roditelja koji su našli idealan vrtić za svoju decu
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Pretraga razmena</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Kako funkcioniše</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Cenovnik</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Kolačići</a></li>
              </ul>
            </div>
          </div>
