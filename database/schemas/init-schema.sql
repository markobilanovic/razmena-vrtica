...
\restrict w0ljc4F9yewhtkOvmgNb2P71ahSzhzIZA1hTSURQs7uzq5FehZ4ZOe1lMZSetSa
...
-- Try to create the extension, but don't fail if it already exists or user lacks privileges
DO $$
BEGIN
    CREATE EXTENSION IF NOT EXISTS "uuid-ossp" WITH SCHEMA public;
EXCEPTION WHEN insufficient_privilege THEN
    -- Extension might already exist or need superuser privileges
    -- Check if the function exists, if not, we'll use gen_random_uuid() instead
    NULL;
END
$$;
...
-- Only add comment if extension was created successfully
DO $$
BEGIN
...
\unrestrict w0ljc4F9yewhtkOvmgNb2P71ahSzhzIZA1hTSURQs7uzq5FehZ4ZOe1lMZSetSa
